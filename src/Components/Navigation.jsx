...
function Navigation(){
  ...
  return(
<div className="sticky flex flex-wrap place-items-center  w-[100%]">
  <section className="relative mx-auto w-[100%]">
    <nav className="flex justify-between bg-gray-900 text-white w-[100%]">
      ...
      <a className="navbar-burger self-center mr-5 xl:hidden" href="#" onClick={handleMobileMenu}>
          <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 hover:text-gray-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
